...
public class Main {
	public static void main(String args[]) throws IOException{
		...
		System.out.println("SIMPLE INDEXING");
		pri stu = new pri();
		sec stu1 = new sec();
        ...
        System.out.println("Building the primary index took :"+(total_time/1000000)+"milli-seconds \n");
        System.out.println("Building the primary index file completed!"); 
        
		System.out.println("Building the  secondary index \n");
		System.out.println("Please wait \n");
		
		long init_time1 = System.nanoTime();
		stu1.indexing();
		stu1.priIndex();
		
		long end_time1 =System.nanoTime();
        long total_time1=end_time1-init_time1;
        System.out.println("Building the secondary index took :"+(total_time1/1000000)+"milli-seconds \n");
        System.out.println("Building the secondary index file completed!");
